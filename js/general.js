...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (
      $(
        "form#simplenews-subscriptions-block-f61c8429-5940-4215-81f7-91264c8c34cf"
      ).length
    ) {
      var base_url = $("#base_url").val();
      var encryptUrl = base_url + "encrypt/jencrypt";
      ...
      if ($(".indexBanner .item").length) {
        setTimeout(function () {
          $(".indexBanner .item > img").each(function () {
            ...
            $(this)
              .parent()
              .css("background-image", "url(" + banimgSrc + ")");
          });
        }, 2000);
      }
    }
    ...
    if ($(".stpiOpenChallImgHolder img").length) {
      $(".stpiOpenChallImgHolder  img").each(function () {
        var banimgSrc = $(this).attr("src");
        $(this)
          .parents(".stpiOpenChallImgHolder")
          .css("background-image", "url(" + banimgSrc + ")");
      });
    }
    ...
    $("a")
      .not(
        ".litebox, .singleVideoPopup, .colorbox, .video-popup,.socialIcone a,.directorateInfo a, .noExteMessage"
      )
      .filter(function () {
    ...
    if ($(".TeamMembersSlider").length) {
      ...
      $(".TeamMembersSlider").append(
        '<div class="teamMobSlider"><div class="owlCarousel"></div></div>'
      );
      ...
      $(".videoplayer").each(function () {
        ...
        projekktor(
          $this,
          {
            ...
            fullscreen: true,
            addplugins: ["related"],
            playlist: [{ 0: { src: video, type: videotype } }],
            plugin_display: {
              logoImage: "",
              logoDelay: 1,
            },
    ...
    if ($("#nav").length) {
      if ($(".toggleMenu").length == 0) {
        $("#mainNav").prepend(
          '<a href="#" class="toggleMenu"><span class="mobileMenu">Menu</span><span class="iconBar"></span></a>'
        );
      }
    ...
    if ($(".ourService").length) {
      $(".ourService").append(
        "<div class='servicesMobSlider owlCarousel '></div>"
      );
      var serviceBoxWrap = $(".serviceBoxWrap").clone();
      $(".servicesMobSlider").append(serviceBoxWrap);
      $(".servicesMobSlider .serviceBoxWrap").each(function () {
    ...
    if ($(".centerOfExce").length) {
      $(".centerOfExce").prepend(
        "<div class='rotatingMobSlider owlCarousel '></div>"
      );
    ...
    if ($(".centerOfExce").length) {
      ...
      setTimeout(function () {
        $(".rotatingMobSlider .owl-item:first")
          .find("a.tab")
          .addClass("selected");
      }, 800);
    }
    ...
    $(" #view-directorate #directorateInfo[data-id = '384']").addClass(
      "active"
    );
    $(" #view-directorate").each(function () {
      $(" #view-directorate #directorateInfo").css("display", "none");
    });
    $(" #view-directorate #directorateInfo[data-id = '384']").css(
      "display",
      "block"
    );
    //map js
      ...
      $(" #view-directorate .directorateInfo[data-id]").each(function () {
        ...
        if (data == allDataDirectorateId) {
          ...
          if ($(" #view-directorate #directorateInfo").hasClass("active")) {
            $(".col-xxl-4 #view-directorate #directorateInfo").css(
              "display",
              "none"
            );
        ...
        $.fn.rotatingSlider = function (options) {
          var rotatingSlider = {
            ...
            renderSlider: function () {
              ...
              var lowerArcOffset =
                (slideFullWidth - Math.sin(halfAngleRadian) * innerRadius * 2) /
                2;
    ...
    $(".coeTab .tabContainer .tabContent[data-id = '4']").css(
      "display",
      "block"
    );
    ...
    $("button").click(function () {
      setTimeout(function () {
        $(".slides li.active-slide .tab").addClass("test");
      }, 3000);
    });
...
$.fn.socialSharingPopup = function (e, intWidth, intHeight, blnResize) {
  ...
  var strTitle =
      typeof this.attr("title") !== "undefined"
        ...
        : "Social Share",
    strParam =
      "width=" + intWidth + ",height=" + intHeight + ",resizable=" + strResize,
