...
$(function () {
  $("#accessControl").show();
  akAccess = (function () {
    var e = { normal: "81.3%", large: "87.5%", larger: "100.0%" };
...
!(function (a, b) {
  ...
  var d = "equalHeight",
    e = { wait: !1, responsive: !0 };
  (c.prototype = {
    init: function () {
      this.options.wait || this.start(),
        this.options.responsive &&
          a(b).on("resize", a.proxy(this.onWindowResize, this));
    },
    magic: function () {
      var b = 0;
      this.reset();
...
(function ($) {
  ...
  var methods = {
      init: function (options) {
        var defaults = {
            ...
            snapAmount:
              null /* optional element always snaps to a multiple of this number in pixels */,
      ...
      scrolling: function (
        ...
        if (!$this.data("bindEvent_scrollbar_drag")) {
          ...
          if ($.support.msPointer) {
            ...
            $(document)
              .bind(
                "MSPointerMove." + $this.data("mCustomScrollbarIndex"),
                function (e) {
                  e.preventDefault();
              ...
              .bind(
                "MSPointerUp." + $this.data("mCustomScrollbarIndex"),
                function (e) {
            ...
            $(document)
              ...
              .bind(
                "mouseup." + $this.data("mCustomScrollbarIndex"),
                function (e) {
                  $this.data({ on_drag: false });
                  mCSB_dragger.removeClass("mCSB_dragger_onDrag");
                }
            ...
            if ($this.data("horizontalScroll")) {
              ...
              if (!$this.data("bindEvent_buttonsContinuous_x")) {
                ...
                mCSB_buttonRight.bind(
                  "mousedown touchstart MSPointerDown",
                  function (e) {
                    e.preventDefault();
                ...
                mCSB_buttonRight.bind(
                  "mouseup touchend MSPointerUp mouseout MSPointerOut",
                  mCSB_buttonRight_stop
                );
                /*scroll left*/
          ...
          this.mcs = {
            ...
            leftPct: Math.round(
              (100 * Math.abs(mCSB_container.position().left)) /
                Math.abs(mCSB_container.outerWidth() - mCustomScrollBox.width())
            ),
          };
          switch (cb) {
  ...
  $.event.special.mousewheel ||
    document.write(
      '<script src="https://stpi.in/themes/stpi/js/mouse-wheel.js"></script>'
    );
  /*plugin fn*/
...
(function (e, t) {
  ...
  e.extend(e.ui, { datepicker: { version: "" } });
  var n,
    r = "datepicker";
...
(function (e, t) {
  var n = {
    ...
    finishbuildConfirm: function (r, i, s) {
      n.listen(
        t.getElementById("confirm-cancel-" + i.newid),
        "click",
        function () {
          n.destroy(i.type, i.newid);
          i.callback(false);
    ...
    finishbuildQuiz: function (r, i, s) {
      var o, u, a;
      n.listen(
        t.getElementById("quiz-cancel-" + i.newid),
        "click",
        function () {
          n.destroy(i.type, i.newid);
          i.callback(false);
    ...
    finishbuildPrompt: function (r, i, s) {
      ...
      n.listen(
        t.getElementById("prompt-cancel-" + i.newid),
        "click",
        function () {
          n.destroy(i.type, i.newid);
          i.callback(false);
...
!(function (a, b, c, d) {
  ...
  function f(a, b) {
    ...
    c &&
      (v(c)
        ? c.call(b[0])
        : b.addClass(c.addClass || "").removeClass(c.removeClass || "")),
      b.trigger("lazy" + a, [b]),
      j();
  }
  function g(b) {
        ...
        if (a.contains(q, n)) {
          if (c || !p.visibleOnly || n.offsetWidth || n.offsetHeight) {
            if (!t) {
              ...
              (k = w.top + h - A - i),
                (t =
                  h >= k && w.bottom > -A && w.left <= j + x && w.right > -x);
            }
            if (t) {
              f("show", l);
              var B = p.srcAttr,
  ...
  var m = "lazyLoadXT",
    ...
    s = {
      ...
      onshow: { addClass: p },
      onload: { removeClass: p, addClass: "lazy-loaded" },
      onerror: { removeClass: p },
      checkDuplicates: !0,
    },
  ...
  (a[m] = w(s, t, a[m])),
    (a.fn[m] = function (c) {
      ...
      return this.each(function () {
        if (this === b) a(s.selector).lazyLoadXT(c);
          ...
          g && "IMG" === d[0].tagName && !this.src && (this.src = g),
            (d[m] = w({}, k)),
            f("init", d),
            y.push(d);
        }
    ...
    a(c).ready(function () {
      f("start", u),
        u.on(s.loadEvent, k).on(s.updateEvent, j).on(s.forceEvent, l),
        s.autoInit && k();
    });
